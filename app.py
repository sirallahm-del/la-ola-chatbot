...
.quick button { background:#1e293b; border:none; color:white; padding:8px 12px; border-radius:8px; }
</style>
</head>
...
You coming tonight or just checking? 👀"""
        })
    ...
    if "book" in msg or "reserve" in msg:
        return jsonify({
            "reply": """Nice 👀<br><br>
You can reserve via Instagram DM @laolarooftop 📩<br><br>
Or tell me — how many people?"""
        })

    # EVENTS
    if "event" in msg or "music" in msg:
        return jsonify({
            "reply": """We have DJ sets & a great vibe at night 🎶🔥<br><br>
